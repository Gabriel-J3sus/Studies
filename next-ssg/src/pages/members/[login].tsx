...
export const getStaticPaths: GetStaticPaths = async () => {  //shows me what I need to about something depending on a non static parameter
...
export const getStaticProps: GetStaticProps = async (context) => {  //Generates a Static Page
